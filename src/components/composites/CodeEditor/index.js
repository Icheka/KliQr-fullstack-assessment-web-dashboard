...
const CodeEditor = (props) => {
    ...
    return (
        <div className={`col-12 d-flex flex-row py-2 px-3 m-0`}>
            <div className={`col-6 m-0 cx_border-all`}>
                <CodeMirror
                    ref={codeMirrorRef}
                    value={context.code}
                    options={{
            ...
            <div className={`text-white cx_border-all cx_bgdark col-6 m-0 cx_logs cx_scrollbar py-3 px-2 cx_overflow_y_scroll border-left-0`} style={{ height: editorHeight }}>
                <div
